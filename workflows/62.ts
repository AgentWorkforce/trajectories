...
IMPORTANT: Write your complete output to the file .relay/specs/62-settings-view.md on disk. This ensures clean handoff to the implementer.`,
    verification: {
      type: "file_exists",
      value: ".relay/specs/62-settings-view.md",
    },
  })
  ...
  .step("read-spec", {
    type: "deterministic",
    dependsOn: ["plan"],
    command: "cat .relay/specs/62-settings-view.md",
    captureOutput: true,
  })
