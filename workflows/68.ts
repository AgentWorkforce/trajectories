...
IMPORTANT: Write your complete output to the file .relay/specs/68-file-detail-modal.md on disk. This ensures clean handoff to the implementer.`,
    verification: {
      type: "file_exists",
      value: ".relay/specs/68-file-detail-modal.md",
    },
  })
  ...
  .step("read-spec", {
    type: "deterministic",
    dependsOn: ["plan"],
    command: "cat .relay/specs/68-file-detail-modal.md",
    captureOutput: true,
  })
