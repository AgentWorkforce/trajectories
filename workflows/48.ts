...
IMPORTANT: Write your complete output to the file .relay/specs/48-trajectory-detail.md on disk. This ensures clean handoff to the implementer.`,
    verification: {
      type: "file_exists",
      value: ".relay/specs/48-trajectory-detail.md",
    },
  })
  ...
  .step("read-spec", {
    type: "deterministic",
    dependsOn: ["plan"],
    command: "cat .relay/specs/48-trajectory-detail.md",
    captureOutput: true,
  })
